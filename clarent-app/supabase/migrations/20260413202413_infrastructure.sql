...
-- ============================================================================
-- updated_at triggers (audit_log is append-only, no updated_at column)
-- ============================================================================

CREATE TRIGGER set_updated_at BEFORE UPDATE ON "communication_log" FOR EACH ROW EXECUTE FUNCTION set_updated_at();
